...
<script>
		function valform(form){
			...
			{
				alert("Please Enter a PNR Number in the field");
				return false;
			}
...
<ul>
  ...
  <li><a class="active" href=bkinfo.php>Booking Info.</a></li>
...
<div class="sign_in1">
	<form name="form" id="form" method="POST" action="bkinfo1.php" ... onsubmit="return valform(this);">
		<p style="font-size: 30px;">PNR Number:-<input type="text" name="pnr" id="pnr" style="margin-left:60px;padding: 7px;width:40%;font-family: 'Amatic SC',cursive;font-size: 25px;">
...
if(mysql_num_rows($result)>0)
{
  ...
  {
    echo "No Bookings Up till Now";
  }  
?> 
 </table>
<button><a href="base.php">Back to Admin Page</a></button>
