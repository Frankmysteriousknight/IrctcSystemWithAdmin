...
$sql="SELECT * FROM trains WHERE Tnumber='$tn'";
$sql1="SELECT * FROM rajdhani WHERE Tnumber='$tn'";
$result=mysql_query($sql);
$res=mysql_query($sql1);
if(mysql_num_rows($result)>0 || mysql_num_rows($res)>0)
{
  $query1="DELETE FROM trains WHERE Tnumber='$tn'";
  $query2="DELETE FROM rajdhani WHERE Tnumber='$tn'";
  mysql_query($query1);
  mysql_query($query2);
  ?>
