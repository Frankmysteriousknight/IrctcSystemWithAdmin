...
mysql_select_db("debuggers");
$sql="SELECT * FROM flights WHERE Flightnum='$tn'";
$sql1="SELECT * FROM airinfo WHERE Fnumber='$tn'";
$result=mysql_query($sql);
$res=mysql_query($sql1);
if(mysql_num_rows($result)>0 || mysql_num_rows($res)>0)
{
  $query1="DELETE FROM flights WHERE Flightnum='$tn'";
  $query2="DELETE FROM airinfo WHERE Fnumber='$tn'";
  mysql_query($query1);
  mysql_query($query2);
  ?>
<H2 style="font-size: 20px;font-family:'Amatic SC',Cursive; padding-left: 520px;">Your Train Information Has Been Deleted!!</H2>
  <?php
  }
  
else 
  { echo "<H2>";
    echo "<td>Sorry,No records to Delete</td>";
    echo "</H2>";
  }  
?> 
 <div id="slider">
