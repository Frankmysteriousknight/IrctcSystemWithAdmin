...
<ul>
  ...
  <li><a class="active" href="trinfo.php">Train Info.</a></li>
 ...
 <br><h2 style="font-family:'Amatic SC',Cursive;font-size: 30px;margin-left:540px;">Here are the results for your findings</h2>
	<table>
...
mysql_connect($servername,$username,$password);
mysql_select_db("irctc");
$sql="SELECT * FROM rajdhani WHERE Tnumber='$tn'";
$result=mysql_query($sql);
if(mysql_num_rows($result)>0)
{
  while($row=mysql_fetch_assoc($result))
...
<button class="button"><a href="trinfo.php">Back to Previous Page</a></button>
