...
<ul>
  ...
  <li><a class="active" href=deltrain.php>Delete Train</a></li>
  <li style="float:right;"><a href="Logout.php">Logout</a></li>
  <li style="float:right;"><a href="base.php"><?php echo "Welcome ".$_SESSION['username'];?></a></li>

</ul>
<div class="sign_in1">
  <form name="form" id="form" method="POST" action="deltrain1.php" ... onsubmit="return valform(this);">
    <p style="font-size: 30px;">Enter The Train no. To delete its data:-<input type="number" name="tno" id="tno" style="margin-left:60px;padding: 7px;width:40%;font-family: 'Amatic SC',cursive;font-size: 25px;">
    <input type="submit" name="submit" class="button">
  </form> 
</div><br>
<H2 style="font-size: 20px;font-family:'Amatic SC',Cursive; padding-left: 520px;">You can View the information of the trains available in your database</H2>
  <table>
