...
<div class="sign_in1">
	<form name="form" id="form" method="POST" action="trinfo1.php" ... onsubmit="return valform(this);">
		<p style="font-size: 30px;">Train no.:-<input type="number" name="tno" id="tno" style="margin-left:60px;padding: 7px;width:40%;font-family: 'Amatic SC',cursive;font-size: 25px;">
