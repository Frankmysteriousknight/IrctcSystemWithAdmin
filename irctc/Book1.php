<script type="text/javascript">
	alert("You Have Not Done any Bookings Yet!!");
</script>
<?php
session_start();
...
<form name="form" id="form" method="POST" action="Booking.php" action="booktrain.php" ... onsubmit="return validform(this);">
	...
	From:<br><input type="text" name="frm" style="margin-left:60px;padding: 7px;width:90%;font-family: 'Amatic SC',cursive;font-size: 25px;"><br>
	To:<br><input type="text" name="to" style="margin-left:60px;padding: 7px;width:90%;font-family: 'Amatic SC',cursive;font-size: 25px;"><br>
   Date of Travelling:-<br><input type="date" name="d1" style="margin-left:60px;padding: 7px;width:90%;font-family: 'Amatic SC',cursive;font-size: 25px;"><br>
