...
<ul>
  ...
  <h2 style="font-size: 20px;font-family:'Amatic SC',Cursive; padding-left: 500px;">Here are the results for your findings</h2>
	<table>
      <tr>
        <td>Name</td>
        <td>PNR</td>
...
<button class="button"><a href="bkinfo.php">Back to Previous Page</a></button>
