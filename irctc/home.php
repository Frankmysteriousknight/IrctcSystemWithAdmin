...
<script>
	function validform(form){
		...
		document.getElementById("demo2").innerHTML = md.getDate();
		if(md<=cd)
		{
			alert("Please Enter the day for tomorrow/today");
			return false;
		}
    ...
    var val1=f.options[f.selectedIndex].text;
    document.getElementById("n2").value=val1;
   }  
...
<div class="sign_in1">	
<form name="form" id="form" method="POST" action="Booking.php" action="booktrain.php" ... onsubmit="return train();">
	
	From:<br>
		<SELECT name="a1" Id=a1 style="margin-left:60px;padding: 7px;width:90%;font-family: 'Amatic SC',cursive;font-size: 25px;">
    <OPTION value="default">--select--</OPTION>
    <OPTION value="Kollam">Kollam</OPTION>
    <OPTION value="Manglore">Manglaore</OPTION>
...
<br>
	To:<br><SELECT name="a2" Id=a2 style="margin-left:60px;padding: 7px;width:90%;font-family: 'Amatic SC',cursive;font-size: 25px;">
    <OPTION value="default">--select--</OPTION>
    <OPTION value="Kollam">Kollam</OPTION>
    <OPTION value="Manglore">Manglaore</OPTION>
    <OPTION value="Kannur">Kannur</OPTION>
  ...
  </SELECT><br>Date of Travelling:-<br><input type="date" name="d1" min="2018-06-27" style="margin-left:60px;padding: 7px;width:90%;font-family: 'Amatic SC',cursive;font-size: 25px;"><br>
	<input type="submit" name="submit" class="button" onsubmit="Check();">
