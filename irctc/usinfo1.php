...
<h2 style="font-size: 20px;font-family:'Amatic SC',Cursive; padding-left: 520px;">Here are the results for your findings</h2>
	<table>
...
<button class="button"><a href="usinfo.php">Back to Previous Page</a></button>
